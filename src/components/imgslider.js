    ...
    Modal.info({
      ...
      content: (
        <div style={{ overflowY: "auto", maxHeight: 600 }}>
          ...
          <p className="fontBold">以下内容之中：</p>
          <p className="fontBold">
            <span className="fontred">X-</span>部分为平台严令禁止发布的内容。
          </p>
          <p className="fontBold">
            <span className="fontgreen">O-</span>
            部分为平台限制内容。在进行发布时，必须主动选择内容属性为“限制内容”。（“限制内容”对于未认证用户及已认证但年龄未满18周岁的用户，将会不可见。）
          </p>
          <p className="headings">1.法律与道德相关</p>
          <p>
            <span className="fontred">X-</span>与我国现有法律法规相违背的内容
          </p>
          <p>
            <span className="fontred">X-</span>
            美化罪犯形象、足以引起对罪犯同情或赞赏的内容
          </p>
          <p>
            <span className="fontred">X-</span>唆使他人蔑视法律尊严的内容
          </p>
          <p>
            <span className="fontred">X-</span>
            描述犯罪方法或细节，会诱发或鼓动人们模仿犯罪行为的内容
          </p>
          <p>
            <span className="fontred">X-</span>
            正面肯定或诱导他人进行犯罪行为的内容
          ...
          <p>
            <span className="fontred">X-</span>宣扬黑社会组织的内容
          </p>
          <p>
            <span className="fontred">X-</span>宣扬毒品及其他违禁药品的内容
          </p>
          <p className="headings">2.血腥与暴力相关</p>
          <p>
            <span className="fontred">X-</span>宣扬、美化暴力行为的内容
          </p>
          <p>
            <span className="fontred">X-</span>过于真实的残缺肢体、内脏描写/描绘
          </p>
          <p>
            <span className="fontred">X-</span>引发肢体残缺的行为或场景
          </p>
          <p>
            <span className="fontred">X-</span>
            过于惨烈或不人道的死亡方式及相关内容（虐杀、侮辱尸体等）
          </p>
          <p>
            {" "}
            <span className="fontgreen">O-</span>造成出血的格斗、战斗场景
          </p>
          <p>
            {" "}
            <span className="fontgreen">O-</span>暴力殴打、致残的情节
          </p>
          <p>
            {" "}
            <span className="fontgreen">O-</span>不过激的死亡场景
          </p>
          <p className="headings">3.性内容相关</p>
          <p>
            <span className="fontred">X-</span>生殖器的直接裸露
          </p>
          <p>
            <span className="fontred">X-</span>肛门、乳房等隐私器官的直接裸露
          </p>
          <p>
            <span className="fontred">X-</span>直接的性爱场景
          </p>
          <p>
            <span className="fontred">X-</span>
            宣扬或正面肯定偷窥、猥亵、强奸女性等行为的内容
          </p>
          <p>
            <span className="fontred">X-</span>
            一切涉及儿童性行为的内容（包括设定上实际成年，但角色依旧拥有儿童体型的内容）
          </p>
          <p>
            <span className="fontgreen">O-</span>不露点的肢体裸露
          </p>
          <p>
            <span className="fontgreen">O-</span>不露点的敏感部位触碰
          </p>
          <p>
            <span className="fontgreen">O-</span>带有挑逗、性暗示意味的姿势造型
          </p>
          <p>
            <span className="fontgreen">O-</span>
            不进行直接描述的、隐晦的性爱场景
          </p>
          <p className="headings">4.历史与文化相关</p>
          <p>
            <span className="fontred">X-</span>任何纳粹相关的标记、符号
          </p>
          <p>
            <span className="fontred">X-</span>宣扬邪教思想的内容
          </p>
          <p>
            <span className="fontred">X-</span>诋毁、歪曲社会主义先进思想的内容
          </p>
          <p>
            <span className="fontred">X-</span>
            歪曲民族英雄、否定英雄烈士事迹与精神的内容
          </p>
          <p>
            <span className="fontred">X-</span>与种族歧视相关的内容
          </p>
          <p>
            <span className="fontred">X-</span>与性别歧视相关的内容
          </p>
          <h2>二．平台内TAG使用规范</h2>
          <p className="fontBold">
          ...
          <p>
            ...
            <span className="underline">
              需主动打上相关TAG（如原作名称、相关角色姓名等），
            </span>
            以便于内容的在阿瓦隆发布归类于搜索。
          </p>
          <p>
            2.若您发布的作品含有CP向，{" "}
            <span className="underline">需要明确CP之间双方的属性。</span>
            以“攻”、“受”为例，您的TAG使用，需要遵循“攻”X“受”、“攻all”、“all受”的格式，以避免产生不必要的误会与争论。
          </p>
          <p>
            3.若您发布的作品涉及前文之中所提及的限制内容，您必须在发布之时，{" "}
            <span className="underline">主动地选择内容属性为“限制内容”，</span>
            使其对于未认证用户以及青少年用户不可见。
          </p>
          <p>
            4.若您发布的作品之中，含有部分
            <span className="underline">“雷点”，</span>
            您在发布时
            <span className="underline">
              除了需要打上相关TAG之外，还需要在“内容简介”中针对内容中的“雷点”进行说明。
            </span>
            该部分内容将会在其他用户点击展开全文时，以
            <span className="underline">
              “阅前须知”的性质弹出，用以进行内容预警。
            </span>
          </p>
          <p>
            5.对于以现实生活之中的<span className="underline">真人</span>
            作为创作原型时，您必须在发布时
            <span className="underline">主动打上“纯属虚构”TAG，</span>
            以避免产生不必要的争执。
          </p>
          <h2>三．平台行为准则</h2>
          <p className="fontBold">
          ...
          <p>
            1.在阿瓦隆平台内，{" "}
            <span className="underline">禁止发布恶意、低俗广告内容。</span>
          </p>
          <p>
            2.在阿瓦隆平台内，{" "}
            <span className="underline">禁止一切人身攻击与辱骂。</span>
          </p>
          <p>
            3.在阿瓦隆平台内，{" "}
            <span className="underline">禁止一切的拉踩、引战行为。</span>
          </p>
          <p>
            4.在阿瓦隆平台内，{" "}
            <span className="underline">
              禁止一切抄袭、盗图，以及未经许可的转载等行为。
            </span>
          </p>
          <p>
            5.在阿瓦隆平台内，{" "}
            <span className="underline">
              禁止一切挂人行为。如您遇到问题或是与其他用户发生纠纷，应当通过平台内的投诉途径，向我们转达。我们将以第三方的立场进行核实与判定。
            </span>
          </p>
          <p>
            6.{" "}
            <span className="underline">
              对于公开表示不欢迎以自身为原型的同人创作的人或组织，您需要尊重其意愿，主动停止一切与其人/组织相关的同人创作活动，并删除曾经发布的相关作品。同时通过有效途径告知我们，我们在进行核实确认之后，也将对相关作品不再收录。
            </span>
          </p>
        </div>
      ),
  ...
  openTwo = () => {
    Modal.info({
      ...
      content: (
        <div style={{ overflowY: "auto", maxHeight: 600 }}>
          <p>
            本协议是用户（下称“用户”或“您”）与阿瓦隆之间的协议，阿瓦隆将按照本协议约定之内容为您提供服务。“阿瓦隆”是指阿瓦隆和/或其相关服务可能存在的运营关联单位。
            <span className="fontBold">
              若您不同意本协议中所述任何条款或其后对协议条款的修改，请您不要使用阿瓦隆提供的相关服务。您的使用行为将视作对本协议全部条款的完全接受。请您仔细阅读本协议的全部条款与条件，尤其是协议中黑色加粗的条款
            </span>
          </p>
          <p className="fontBold">
            如您为未成年人的，请在法定监护人的陪同下阅读和判断是否同意本协议，特别注意未成年人条款。未成年人行使和履行本协议项下的权利和义务视为已获得监护人的认可。
          </p>
          <p className="fontBold">1.服务说明</p>
          ...
          <p className="fontBold">2用户注册</p>
          <p>
            如果您使用阿瓦隆提供的网络存储空间进行视听节目、文字、美术摄影等的上传及传播服务，您需要注册一个账号并设置密码，并确保注册信息的真实性、正确性及完整性，如果上述注册信息发生变化，您应及时更改。在完成本服务的登记程序后，
            <span className="fontBold">
              您应维护账号及密码的机密安全。您应对任何人利用您的账号及密码所进行的活动完全负责，阿瓦隆无法对非法或未经您授权使用您账号及密码的行为作出甄别，因此阿瓦隆将不承担任何责任。
            </span>
            同时您同意并承诺做到：
          </p>
          <p>
          ...
          <p className="fontBold">
            2.4您承诺不在注册、使用阿瓦隆账号从事以下行为：
          </p>
          <p className="fontBold">
            2.4.1故意冒用他人信息为自己注册阿瓦隆账号；
          </p>
          <p className="fontBold">
            2.4.2未经他人合法授权以他人名义注册阿瓦隆账号；
          </p>
          <p className="fontBold">
            2.4.3窃取、盗用他人的阿瓦隆账号、超赞币、积分、会员标识等；
          </p>
          <p className="fontBold">
          ...
          <p className="fontBold">2.4.6侵犯他人合法权益的其他内容。</p>
          <p className="fontBold">
          ...
          <p className="fontBold">3阿瓦隆上的内容</p>
          <p>
          ...
          <p>
            4.3.14您制作、发布、传播的内容需遵守《网络音视频信息服务管理规定》及相关法律法规规定，
            <span className="fontBold">
              不得利用基于深度学习、虚拟现实等的新技术新应用制作、发布、传播虚假新闻信息等法律法规禁止的信息内容。您在发布或传播利用基于深度学习、虚拟现实等的新技术新应用制作的非真实音视频信息时，应当以显著方式予以标识，否则阿瓦隆有权对相关内容和账户采取包括但不限于增加标识、限制、封禁等措施。
            </span>
          </p>
          <p className="fontBold">
          ...
          <p className="fontBold">7.5.1阿瓦隆服务全部或部分无法使用；</p>
          <p className="fontBold">
            7.5.2经由阿瓦隆服务购买或取得的任何产品、资料或服务；
          </p>
          <p className="fontBold">7.5.3用户资料遭到未授权的使用或修改；</p>
          <p className="fontBold">7.5.4其他与阿瓦隆服务相关的事宜。</p>
          <p className="fontBold">
          ...
          <p className="fontBold">8服务的变更、中断、终止</p>
          <p className="fontBold">
          ...
          <p className="fontBold">11未成年人条款</p>
          <p>
          ...
          <p className="fontBold">12法律适用和管辖</p>
          <p>
          ...
          <p className="fontBold">13协议的修改与通知</p>
          <p>
  ...
  openThree = () => {
    Modal.info({
      ...
      content: (
        <div style={{ overflowY: "auto", maxHeight: 600 }}>
          <p>
            以下内容请您仔细阅读并遵守，如在日后的平台使用过程中有违反情况，在我们核实确有其事之后，将
            <span className="underline">有权对您的账号进行处罚。</span>
            视情况的严重程度，
            <span className="underline">
              会处以不同期限的禁言、封停惩罚，最高可至永久期限。
            </span>
          </p>
          ...
          <p>
            1.发布
            <span className="underline">
              违反我国法律法规，或诋毁、歪曲社会主义先进思想
            </span>
            的言论，将直接处以账号<span className="underline">永久禁言。</span>
          </p>
          <p>
            2.发布
            <span className="underline">
          ...
          <p>
            3.发布带有<span className="underline">极端宗教思想</span>
            的言论，将处以
            <span className="underline">30天起步、最高可至永久</span>
            的账号禁言惩罚。
          </p>
          <p>
            4.发布带有
            <span className="underline">
              歧视（包括但不限于：种族歧视、性别歧视、国籍歧视、地域歧视等）思想
            </span>
            的言论，将处以
            <span className="underline">15天起步、最高可至永久</span>
            的账号禁言惩罚。
          </p>
          <p>
            5.发布<span className="underline">谣言或未经核实的虚假内容，</span>
            引起平台内其他用户愤怒、恐慌等负面情绪的行为，将处以{" "}
            <span className="underline">15天起步、最高可至永久</span>
            的账号禁言惩罚。
          </p>
          <p>
            6.于平台内向其他用户进行
            <span className="underline">人身攻击、恶意辱骂</span>
            的行为，将处以
            <span className="underline">7天起步、最高可至永久</span>
            的账号禁言惩罚。
          </p>
          <p>
            7.发布含有 <span className="underline">拉踩、引战信息</span>
            的内容，或
            <span className="underline">
              试图主动挑起用户之间的派别对立、撕逼骂战的言论，
            </span>
            将处以 <span className="underline">7天起步、最高可至永久</span>
            的账号禁言惩罚。
          </p>
          <p className="headings">
          ...
          <p>
            1.
            <span className="underline">
              盗用他人信息进行账号注册与认证，一经发现并核实后，将直接处以账号永久封禁。
            </span>
          </p>
          <p>
            2.
            <span className="underline">
              利用第三方程序或系统漏洞，篡改账号数据（如平台内的货币、积分等），将直接处以账号永久封禁。
            </span>
          </p>
          <p>
            3.于平台内向其他用户进行
            ...
            的行为，将直接处以账号<span className="underline">永久封禁。</span>
          </p>
          <p>
            4.于平台内发布
            <span className="underline">
            ...
            （具体内容详见《阿瓦隆平台内容规范》、《平台相关法律法规》），将视情况处以
            <span className="underline">30天起步、最高可至永久</span>
            的账号封禁。
          </p>
          <p>
            5.于平台内发布
            <span className="underline">恶意低俗广告或违法链接</span>
            ，将视情况处以
            <span className="underline">
              15天起步、最高可至永久的账号封禁。
            </span>
          ...
          <p>
            ...
            （具体内容详见《阿瓦隆平台内容规范》），并在平台内导致造成了
            <span className="underline">
              不良影响，且不听劝说我行我素的行为，
            </span>
            将视情况处以
            <span className="underline">7天起步、最高可至永久的账号封禁。</span>
          </p>
          <p>
            7.{" "}
            <span className="underline">
              平台内设立的投诉功能，意在建立更好的规则与秩序，而非用以攻击中伤的武器。
            </span>
            若有 <span className="underline">滥用投诉</span>
            对他人造成困扰，且屡教不改的，将视情况处以
            <span className="underline">7天起步、最高可至永久的账号封禁。</span>
          </p>
        </div>
      ),
    ...
    Modal.info({
      ...
      content: (
        <div style={{ overflowY: "auto", maxHeight: 600 }}>
          ...
          <p>阿瓦隆为您提供的服务：</p>
          <p className="fontBold">1.“一人、一证、一号”的会员实名服务</p>
          <p>
            我们希望阿瓦隆所带来的，是
            <span className="underline">纯净、高质量的平台环境与氛围。</span>
            因此我们将在平台推行<span className="underline">实名认证。</span>
          </p>
          <p>
            （我们将会根据国家相关法律法规，保护用户的身份信息，个人隐私等不受泄露）。
          </p>
          <p className="underline">
            我们秉持自愿的原则，对实名认证不强制要求。
          </p>
          <p className="underline">
            但未认证的用户，以及经过认证但年龄未满18周岁的用户，将会受到一些限制。具体限制内容详见下文。
          </p>
          <p className="fontBold">2.拒绝一刀切的内容分级制度</p>
          <p>
            作为一个内容平台，我们以
            <span className="underline">“中立秩序”</span>
            的立场，以及“法无明文规定不为罪，
            <span className="underline">法无明文规定不处罚”</span>
            的原则，允许一切
            <span className="underline">不违反我国法律法规的创作内容，</span>
            支持并捍卫创作者们在阿瓦隆平台内，对于自己作品的发布权利。
          </p>
          <p>
            但出于对与青少年人群的保护目的，我们对于
            <span className="underline">
              未认证的用户，以及经过认证但年龄未满18周岁的用户，我们将会在普通模式之下，对于部分内容与功能进行限制（即类似其他内容平台的“青少年模式”）。
            </span>
          </p>
          <p>
            在普通模式下，您任然可以正常享受阿瓦隆的服务，但
            <span className="underline">
              部分作品内容将不可见，且不提供任何的充值以及购买增值服务。
            </span>
          </p>
          <p className="underline">
          ...
          <p>
            与普通模式对应的
            <span className="underline">
              会员模式，是我们的增值服务之一。会员模式除必须实名认证外，需要支付18元/月的费用。开启会员模式后，您可以享受阿瓦隆所提供的一切内容与服务。
            </span>
          </p>
          <p>附-用户属性与对应权限一览表：</p>
          <p>
            <table style={{ fontWeight: "bold" }} className="fontTbale">
              <thead style={{ border: "1px solid #000" }}>
                <tr>
                  <th style={{ borderRight: "1px solid #000" }}>用户属性</th>
              ...
              <tbody style={{ border: "1px solid #000" }}>
                <tr style={{ border: "1px solid #000" }}>
                  <td style={{ borderRight: "1px solid #000" }}>未认证用户</td>
                  <td style={{ borderRight: "1px solid #000" }}>X</td>
                  <td>X</td>
                </tr>
                <tr style={{ border: "1px solid #000" }}>
          ...
          <p className="fontBold">3.阿瓦隆特有的全新增值服务——“超赞”</p>
          <p>
          ...
          <p>
            因此，{" "}
            <span className="underline">
              我们针对同人圈层的特性，定制了一项全新的增值服务——“超赞”。
            </span>
          </p>
          <p>
            我们深度挖掘了“打赏”背后的意义——
            <span className="underline">
              愿意为了自己喜欢的作品而付费，这一行为本身所表达的核心意义，是认可。
            </span>
          </p>
          <p className="underline">
